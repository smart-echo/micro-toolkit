...
```
go install github.com/smart-echo/micro-toolkits/cmd/protoc-gen-micro
```
...
The proto generates a `RegisterGreeterHandler` function with a [api.Endpoint](https://godoc.org/github.com/smart-echo/micro/api#Endpoint). 
